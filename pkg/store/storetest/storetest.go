...
// seedRD inserts a minimal ResourceDefinition under `name` so a
// shared test can land a dependent row (Snapshot, Resource, ...)
// without spelling out a full RD literal.
