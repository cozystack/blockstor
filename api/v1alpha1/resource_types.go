...
type ResourceSpec struct {
	...
	// +optional
	// +kubebuilder:validation:XValidation:rule="!oldSelf.hasValue() || self == oldSelf.value()",optionalOldSelf=true,message="skipInitialSync is settable-once: it may go from unset to a value but not be changed once set"
